...
<div class="center_">
    <div class="target_">Font size: 14px</div>
</div>
...
<div class="per_">
    <div class="per2_">Font size: 14px * 120% → 16.8px</div>
</div>
...
<div class="em_">
    <div class="em1_">Font size: 1.2em → 14px * 1.2 = 16.8px</div>
</div>
...
<div class="em__ ">
    <div class='em1__ box1'>
    Font size: 1.2em ⇒ 14px * 1.2 = 16.8px
        <div class='em1__ box2'>
        Font size: 1.2em ⇒ 16.8px * 1.2 = 20.16px
        <div class='em1__ box3'>
            Font size: 1.2em ⇒ 20.16px * 1.2 = 24.192px
        </div>
        </div>
    </div>
...
<div class="rem_">
    <div class='rem1_ box1'>
        Font size: 1.2rem ⇒ 14px * 1.2 = 16.8px
        <div class='rem1_ box2'>
        Font size: 1.2rem ⇒ 14px * 1.2 = 16.8px
        <div class='rem1_ box3'>
            Font size: 1.2rem ⇒ 14px * 1.2 = 16.8px
        </div>
        </div>
    </div>
...
<style>
.view_ { margin: 0px; overflow:auto; height: 500px;}
.item {
    width: 50vw;
    height: 100vh;
    text-align: center;
