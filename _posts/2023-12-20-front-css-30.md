...
<span class="ft-small">
해당 본문은 poiemaweb의 [**반응형 레이아웃**](https://poiemaweb.com/css3-responsive-web-design) 를 필사하였다.
</span>
...
![img01](/assets/img/posts/front/20231220_30_01.png){: .w-75 .h-15 .rounded-10 } 

그리고 모바일과 같이 작은 해상도의 디바이스에서 접근했을 때 화면이 너무 작아져 가시성에 문제가 발생한다.

![img02](/assets/img/posts/front/20231220_30_02.jpeg){: .w-45 .h-75 .rounded-10 } 
...
이러한 문제를 해결하는 방법 중의 하나가 **반응형 웹디자인(Responsive Web Design)**이다. 화면 해상도에 따라 가로폭이나 배치를 변경하여 가독성을 높이는 것이다. 즉, <span class="bg-yllw">**하나의 웹사이트를 구축하여 다양한 디바이스의 화면 해상도에 최적화된 웹사이트를 제공하는 것이다.**</span>

![img03](/assets/img/posts/front/20231220_30_03.png){: .w-75 .h-15 .rounded-10 } 
...
<span class="bg-yllw">viewport란 **웹페이지의 가시영역을 의미**한다. viewport는 **디바이스에 따라 차이가 있다.**</span> 
...
![img04](/assets/img/posts/front/20231220_30_04.jpeg){: .w-45 .h-75 .rounded-10 } 

![img05](/assets/img/posts/front/20231220_30_05.png){: .w-45 .h-75 .rounded-10 } 

meta tag는 **브라우저 혹은 검색엔진최적화(SEO)를 위해 검색엔진에게 메타데이터를 전달하기 위해 사용**된다.

viewport meta tag는 **브라우저의 화면 설정과 관련된 정보를 제공**한다.
...
| maximum-scale | viewport최대 배율               | maximum-scale=2.0 |
| minimum-scale | viewport최소 배율               | minimum-scale=1.0 |

meta tag에서는 px단위를 사용하며 단위 표현은 생략한다. 복수개의 프로퍼티를 사용할 때는 쉼표(,)로 구분한다.

<span class="bg-yllw">**일반적으로 viewport meta tag는 모바일 디바이스에서만 적용된다.**</span>
...
이것은 <span class="bg-yllw">**서로 다른 미디어 타입(print, screen…)에 따라 각각의 styles을 지정하는 것을 가능하게 한다.**</span>
...
`@media`<u>을 사용하여 미디어 별로 style을 지정하는 것을</u>`Media Query`<u>라 한다.</u>

<span class="bg-yllw">**디바이스를 지정하는 것뿐만 아니라 디바이스의 크기나 비율까지 구분할 수 있다.**</span> 
...
[W3C > Media Queries > Media features](https://www.w3.org/TR/mediaqueries-3/#media1)
...
![img06](/assets/img/posts/front/20231220_30_06.jpeg){: .w-15 .h-75 .rounded-10 } 
...
{% include embed/example.html height="260px"
content='
<!DOCTYPE html>
<html>
<head>
...
### **1. Responsive Navigation Bar - Tablet**
...
![img07](/assets/img/posts/front/20231220_30_07.png){: .w-45 .h-75 .rounded-10 } 

### **2. Responsive Navigation Bar - Smartphone**
...
![img08](/assets/img/posts/front/20231220_30_08.png){: .w-45 .h-15 .rounded-10 } 
...
![img09](/assets/img/posts/front/20231220_30_09.png){: .w-45 .h-75 .rounded-10 } 

nav 요소 내에 클릭할 수 있는 navigation icon을 만들기 위한 html tag를 추가한다. l**abel tag의 for 프로퍼티값과 input tag의 id 프로퍼티값이 일치하여야 한다.**
...
![img10](/assets/img/posts/front/20231220_30_10.png){: .w-15 .h-15 .rounded-10 } 
...
![img11](/assets/img/posts/front/20231220_30_11.png){: .w-15 .h-15 .rounded-10 } 
...
![img12](/assets/img/posts/front/20231220_30_12.png){: .w-15 .h-15 .rounded-10 } 
...
![img13](/assets/img/posts/front/20231220_30_13.png){: .w-15 .h-15 .rounded-10 } 
...
navigation icon과 checkbox input tag는 스마트폰 layout 이외의 경우, 화면에 표시되어서는 안된다. 따라서 display: none;으로 화면에 표시되지 않도록 한다. display: none;은 해당 공간조차 점유하지 않지만 visibility: hidden;을 사용하면 해당 공간은 남아있고 표시만 되지 않는다. 참고 : CSS display
...
- [**반응형 레이아웃**](https://poiemaweb.com/css3-responsive-web-design)
