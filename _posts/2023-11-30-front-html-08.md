...
해당 본문은 poiemaweb의 [**이미지의 표현과 동영상, 음악 등 멀티미디어를 지원하는 태그**](https://poiemaweb.com/html5-tag-image-multimedia) 를 필사하였다.
<br/>
<em class="ft-small">집중력을 높이기 위해, poiemaweb의 본문내용을 직접 타이핑하면서 공부하고 있다.</em>

## **이미지**

웹페이지에 이미지를 삽입하는 경우, <u>img tag를 사용</u>한다.
...
<audio src="/assets/audio/20231130_08_02.mp3" controls></audio>
...
<video width="640" height="360" controls>
    <source src="/assets/video/20231130_08_01.mp4" type="video/mp4">
    <source src="/assets/video/20231130_08_01.webm" type="video/webm">
</video>
...
- [**이미지의 표현과 동영상, 음악 등 멀티미디어를 지원하는 태그**](https://poiemaweb.com/html5-tag-image-multimedia)
